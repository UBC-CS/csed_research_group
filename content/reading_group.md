# About the CS Ed Reading Group

This is a reading group open to all faculty and grad students interested in computer science education. We meet every other week to discuss current research in the field. 

Our meetings generally consist of a facilitated discussion of a paper or we may have a guest speaker. Either one of these things is then followed by open discussion. The papers we discuss are suggested by our group members so the topic coverage can be quite wide ranging.

**How to join**: Email cs[dash]ed[dash]rg[dash]request[at]cs.ubc.ca with "join" in the subject or body. Please be sure to replace <code>[dash]</code> with <code>-</code> and [at] with the appropriate symbol.
